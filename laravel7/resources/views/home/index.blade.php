	...
	<div id="content">
		...
		<div class="promo-inner" id="promo">
			...
			<ul id="main_navi">
				...
				<li class="last">
					<img src="/homes/images/slide_small4.jpg">
				...
				<div style="top: -940px;" id="pages">
					...
					<div class="page">
						...
						<div class="scrollable">
							...
							<div class="items">
								...
								<!-- items  -->
								<div class="item">
									<img src="/homes/images/promo1.jpg">
								</div>
								<div class="item">
									<img src="/homes/images/promo4.jpg">
								</div>
								<div class="item">
									<img src="/homes/images/promo5.jpg">
								</div>
					...
					<div class="page">
						...
						<div class="scrollable">
							...
							<div class="item">
									<img src="/homes/images/promo2.jpg">
								</div>
								<div class="item">
									<img src="/homes/images/promo4.jpg">
								</div>
					...
					<div class="page">
						...
						<div class="scrollable">
							...
							<div class="item">
									<img src="/homes/images/promo3.jpg">
								</div>
								<div class="item">
									<img src="/homes/images/promo4.jpg">
								</div>
				   ...
				   <div class="items">
					  ...
					  <div class="group-items">
						 <div class="single-item">
							...
							<img src="/homes/images/product1.png" alt="Item"/>
						...
						<div class="single-item">
							...
							<img src="/homes/images/product2.png" alt="Item"/>
							<a href="#" class="general-button float-left"><span class="button">Add to cart</span></a>
							<span class="list-link">
								<a href="details.html" class="regular">View more...</a>
							</span>
						...
						<div class="single-item">
							...
							<img src="/homes/images/product3.png" alt="Item"/>
							<a href="#" class="general-button float-left"><span class="button">Add to cart</span></a>
							<span class="list-link">
								<a href="details.html" class="regular">View more...</a>
							</span>
						...
						<div class="single-item">
							...
							<img src="/homes/images/product5.png" alt="Item"/>
							<a href="#" class="general-button float-left"><span class="button">Add to cart</span></a>
							<span class="list-link">
								<a href="details.html" class="regular">View more...</a>
							</span>
					  ...
					  <div class="group-items">
						 <div class="single-item">
							...
							<span class="price">$149.90</span>
							<img src="/homes/images/product4.png" alt="Item"/>
							<a href="#" class="general-button float-left"><span class="button">Add to cart</span></a>
							<span class="list-link">
								<a href="details.html" class="regular">View more...</a>
							</span>
						...
						<div class="single-item">
							<span class="title"><a href="details.html">Great New Perfume for Her</a></span>
							<span class="price">$23</span>
							<img src="/homes/images/product6.png" alt="Item"/>
							<a href="#" class="general-button float-left"><span class="button">Add to cart</span></a>
							<span class="list-link">
								<a href="details.html" class="regular">View more...</a>
							</span>
		...
		<div class="content-inner home">
			...
			<div class="one-half float-left">
				...
				<a href="/homes/images/big01.jpg" rel="group4" class="grouped-elements" title="Lorem ipsum dolor sit amet, consecteur adipsing elit. Phasellus elefend, enim non euismod lacinia, urna odio convallis urna, eu comodo mi risus non orci.">
					<img border="0" alt="" src="/homes/images/01.jpg" class="portfolio-image">
					<span class="imagehover"></span>
				</a>
				<a href="/homes/images/big02.jpg" rel="group4" class="grouped-elements" title="Lorem ipsum dolor sit amet, consecteur adipsing elit. Phasellus elefend, enim non euismod lacinia, urna odio convallis urna, eu comodo mi risus non orci.">
					<img border="0" alt="" src="/homes/images/02.jpg" class="portfolio-image">
					<span class="imagehover"></span>
				</a>
				<a href="/homes/images/big03.jpg" rel="group4" class="grouped-elements" title="Lorem ipsum dolor sit amet, consecteur adipsing elit. Phasellus elefend, enim non euismod lacinia, urna odio convallis urna, eu comodo mi risus non orci.">
					<img border="0" alt="" src="/homes/images/03.jpg" class="portfolio-image">
					<span class="imagehover"></span>
				</a>
				<a href="/homes/images/big04.jpg" rel="group4" class="grouped-elements" title="Lorem ipsum dolor sit amet, consecteur adipsing elit. Phasellus elefend, enim non euismod lacinia, urna odio convallis urna, eu comodo mi risus non orci.">
					<img border="0" alt="" src="/homes/images/04.jpg" class="portfolio-image">
					<span class="imagehover"></span>
				</a>
				<a href="/homes/images/big05.jpg" rel="group4" class="grouped-elements" title="Lorem ipsum dolor sit amet, consecteur adipsing elit. Phasellus elefend, enim non euismod lacinia, urna odio convallis urna, eu comodo mi risus non orci.">
					<img border="0" alt="" src="/homes/images/05.jpg" class="portfolio-image">
					<span class="imagehover"></span>
				</a>
				<a href="/homes/images/big06.jpg" rel="group4" class="grouped-elements" title="Lorem ipsum dolor sit amet, consecteur adipsing elit. Phasellus elefend, enim non euismod lacinia, urna odio convallis urna, eu comodo mi risus non orci.">
					<img border="0" alt="" src="/homes/images/06.jpg" class="portfolio-image">
					<span class="imagehover"></span>
				</a>
				<a href="/homes/images/big03.jpg" rel="group4" class="grouped-elements" title="Lorem ipsum dolor sit amet, consecteur adipsing elit. Phasellus elefend, enim non euismod lacinia, urna odio convallis urna, eu comodo mi risus non orci.">
					<img border="0" alt="" src="/homes/images/03.jpg" class="portfolio-image">
